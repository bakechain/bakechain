...
exports.computeNodeModuleFileSets = exports.computeFileSets = exports.transformFiles = exports.copyAppFiles = exports.ELECTRON_COMPILE_SHIM_FILENAME = void 0;
...
let compileUsingElectronCompile = (() => {
  var _ref6 = (0, _bluebirdLst().coroutine)(function* (mainFileSet, packager) {
...
`);
  ...
  return function compileUsingElectronCompile(_x13, _x14) {
...
let transformFiles = (() => {
  var _ref2 = (0, _bluebirdLst().coroutine)(function* (transformer, fileSet) {
    if (transformer == null) {
      return;
    }
  ...
  return function transformFiles(_x4, _x5) {
...
let computeFileSets = (() => {
  var _ref3 = (0, _bluebirdLst().coroutine)(function* (matchers, transformer, platformPackager, isElectronCompile) {
    const fileSets = [];
  ...
  return function computeFileSets(_x6, _x7, _x8, _x9) {
...
let computeNodeModuleFileSets = (() => {
  var _ref4 = (0, _bluebirdLst().coroutine)(function* (platformPackager, mainMatcher) {
    ...
    return yield _bluebirdLst().default.mapSeries(deps, (() => {
      var _ref5 = (0, _bluebirdLst().coroutine)(function* (info) {
  ...
  return function computeNodeModuleFileSets(_x10, _x11) {
